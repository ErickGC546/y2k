    ...
    <header className="w-full">
      ...
      <div className="bg-estilo-dark text-white py-3 px-4 border-t border-gray-800">
        <div className="container mx-auto flex justify-between items-center">
          {/* Logo */}
          <Link to="/" className="text-3xl font-bold font-montserrat tracking-wider text-estilo-gold">
            ESTILO
          </Link>
          ...
          <div className="flex items-center space-x-6">
            <div className="flex items-center">
              <a href="https://wa.me/34600000000" className="text-xs text-estilo-gold mr-2 hidden md:flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="#D4AF37" stroke="currentColor" strokeWidth="0" strokeLinecap="round" strokeLinejoin="round" className="mr-1">
              ...
              <a href="tel:+34600000000" className="hidden md:block">600-000-000</a>
            </div>
