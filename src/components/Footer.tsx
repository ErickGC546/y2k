      ...
      <div className="container mx-auto py-10 px-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-10 border-b border-gray-800 pb-10">
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-sm text-gray-400">Para pedidos superiores a 50€</p>
          </div>
          <div className="flex flex-col items-center text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="mb-6 md:mb-0">
            <h2 className="text-xl font-bold font-montserrat text-estilo-gold mb-4">ESTILO</h2>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li className="flex items-center">
                ...
                <a href="tel:+34600000000" className="text-gray-400 hover:text-estilo-gold transition-colors">+34 600 000 000</a>
              </li>
              <li className="flex items-center">
                <Mail size={18} className="mr-2 flex-shrink-0 text-estilo-gold" />
                <a href="mailto:info@estilo.com" className="text-gray-400 hover:text-estilo-gold transition-colors">info@estilo.com</a>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-10 pt-6 text-center text-sm text-gray-500">
          <p>&copy; {new Date().getFullYear()} ESTILO. Todos los derechos reservados.</p>
